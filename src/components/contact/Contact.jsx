...
export default function Contact() {
  ...
  const contactInfo = [
    {
      icon: <AiOutlineMail className="text-green-400" size={24} />,
      title: "Professional Email",
      value: "abdulqaderahmed32@gmail.com",
      link: "mailto:abdulqaderahmed32@gmail.com",
      description: "Quick response guaranteed within 24 hours",
    },
    {
      icon: <AiOutlinePhone className="text-blue-400" size={24} />,
      title: "Direct Line",
      value: "+251932494626",
      link: "tel:+251932494626",
      description: "Available for consultations Mon-Fri, 9AM-6PM EAT",
    },
    {
      icon: <AiOutlineEnvironment className="text-purple-400" size={24} />,
      title: "Base Location",
      value: "Addis Ababa, Ethiopia",
      link: null,
      description: "Remote-first • Global collaboration ready",
    },
  ];
  ...
  const socialLinks = [
    {
      ...
      followers: "50+ production-ready repositories",
    },
    {
      ...
      followers: "Professional network & recommendations",
    },
    {
      ...
      color: "hover:text-blue-400",
      followers: "Industry insights & tech discussions",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            scalable web applications and delivering results that exceed expectations. Let's discuss 
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {/* Contact Form */}
          <div
            className={`${colors.card} rounded-xl p-8 border ${colors.border}`}
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  rows={6}
                  required
                  className={`w-full pl-10 pr-4 py-3 ${colors.tertiary} border ${colors.border} rounded-lg ${colors.textPrimary} placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 resize-none`}
                ></textarea>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h3 className={`text-2xl font-bold ${colors.textPrimary} mb-6`}>
                Contact Information
              </h3>
              {contactInfo.map((info, index) => (
                <div
                  key={index}
                  className={`${colors.card} rounded-xl p-6 border ${colors.border} hover:border-blue-500 transition-all duration-300 group`}
                >
                  <div className="flex items-start gap-4">
                    <div
                      className={`p-3 ${colors.tertiary} rounded-lg group-hover:bg-slate-600 transition-colors duration-300`}
                    >
                      {info.icon}
                    </div>
                    <div className="flex-1">
                      <h4
                        className={`text-lg font-semibold ${colors.textPrimary} mb-1`}
                      >
                        {info.title}
                      </h4>
                      {info.link ? (
            ...
            >
              <h4 className={`text-xl font-bold ${colors.textPrimary} mb-6`}>
                Follow me
              </h4>
              <div className="space-y-4">
                {socialLinks.map((social, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h5
                        className={`${colors.textPrimary} font-semibold group-hover:text-blue-400 transition-colors duration-300`}
                      >
                        {social.name}
                      </h5>
            ...
            <div className="bg-gradient-to-br from-green-500/10 to-blue-500/10 border border-green-500/20 rounded-xl p-6">
              ...
              <p className={`${colors.textSecondary} text-sm leading-relaxed mb-3`}>
                Accepting new projects and collaborations. Specializing in full-stack development, 
